...
// widget; you implement display, word-wrapping, and low-levelstd::string
...
//   state of a text widget (except for thestd::string, which you will store
//   separately).
//
...
//   refer to positions in thestd::string, implicitly representing positions
...
//
//    STB_TEXTEDIT_STRING               the type of object representing astd::string being edited,
//                                      typically this is a wrapper object with other data you need
//
//    STB_TEXTEDIT_STRINGLEN(obj)       the length of thestd::string (ideally O(1))
...
//
//    Each of these functions potentially updates thestd::string and updates the
//    state.
//
//      initialize_state:
...
//          (To copy, just copy the current selection out of thestd::string yourself.)
//     
//      paste:
...
typedef struct
{
   ...
   int cursor;
   // position of the text cursor within thestd::string
...
// make the selection/cursor state valid if client altered thestd::string
